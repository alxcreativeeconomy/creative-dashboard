...
const cohortGroups = [
  ...
  },
  {
    ...
    pfData: [
      { program: "AI for Creatives", enrolled: 450, graduated: 42, rate: "9.33%", dates: "Sep 22 - Dec 15 '25" },
      { program: "Content Creation", enrolled: 3400, graduated: 510, rate: "15.00%", dates: "Sep 22 - Dec 15 '25" },
      { program: "Graphic Design", enrolled: 1200, graduated: 180, rate: "15.00%", dates: "Sep 22 - Dec 15 '25" },
      { program: "Music & Audio", enrolled: 380, graduated: 65, rate: "17.10%", dates: "Sep 22 - Dec 15 '25" },
    ], 
    ctlsName: 'Creative Tech Lite Specialization Cohort 3',
    ctlsData: [
      { program: "AI for Creatives", enrolled: 610, graduated: "Pending", rate: "N/A", dates: "Jan 12 - May 18 '26" },
      { program: "Content Creation", enrolled: 1850, graduated: "Pending", rate: "N/A", dates: "Jan 12 - May 18 '26" },
      { program: "Graphic Design", enrolled: 480, graduated: "Pending", rate: "N/A", dates: "Jan 12 - May 18 '26" },
      { program: "Music & Audio", enrolled: 250, graduated: "Pending", rate: "N/A", dates: "Jan 12 - May 18 '26" },
    ] 
  }
];
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        {/* Header */}
        <div>
          <h2 className="text-3xl font-bold text-slate-900">Key Metrics Overview</h2>
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-8">
          ...
          {/* Cohort Performance Data Tables & Charts */}
          <Card className="p-0 overflow-hidden flex flex-col">
            <div className="p-6 border-b border-slate-200 bg-white">
              <h3 className="text-xl font-bold text-slate-900">Cohort Performance Tracking</h3>
              <p className="text-sm text-slate-500 mt-1">Learner progression from Professional Foundations directly into Creative Tech Lite Specializations.</p>
            </div>
